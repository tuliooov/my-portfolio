    ...
    <Section row nopadding>
      <LeftSection>
        ...
        <SectionText>
          ...
          in the city of Divinópolis in the state of Minas Gerais - Brazil. I
          work as a <StrongTag>full stack developer at Banco Inter</StrongTag>.
          I am communicative, competitive, optimistic and helpful. In addition,
