...
export const SectionDivider = styled.div<{
  ...
  background: ${(props) =>
    props.colorAlt
      ? 'linear-gradient(270deg, #F46737 0%, #c74545 100%)'
      : 'linear-gradient(270deg, #363636 0%, #c74545 100%)'};
...
export const ButtonBack = styled.div<{
  ...
  background: ${({ alt }) =>
    alt
      ? 'linear-gradient(270deg, #ff622e 0%, #c73131 100%)'
      : 'linear-gradient(270deg, #282828 0%, #c73131 100%)'};
  cursor: pointer;
...
export const ButtonFront = styled.button<{ alt?: boolean }>`
  border: none;
  border-radius: 50px;
  color: #fff;
  display: flex;
